...
function buildConfirmationMessage(
  ...
  switch (toolId) {
    ...
    case "calendar_create_calendar":
      return `Se requiere confirmación para crear el calendario "${args.summary}"${args.timeZone ? ` (zona horaria: ${args.timeZone})` : ""}.`;
    case "calendar_delete_calendar":
      return `Se requiere confirmación para borrar permanentemente el calendario con id "${args.calendarId}". No se puede deshacer.`;
    case "write_file": {
